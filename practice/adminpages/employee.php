...
<body>
    ...
    if (isset($_POST['update_submit'])) {
        ...
        $sqllll = "UPDATE addstaff SET name='$name', DOB='$birth', gender='$gender', address='$address', number='$contact', province='$province', village='$village', email='$email', image='$targetFile', registrationdate='$date', username='$username', password='$Password' WHERE id='$id'";
    ...
    if (isset($_POST['delete_submit'])) {
        $ad_id = $_POST['ad_id'];
        $q = "DELETE FROM addstaff WHERE id='$ad_id'";
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header ">
                    <h1 class="modal-title fs-3 " id="exampleModalLabel"> <span style="margin-left: 150px;">Staff Details</span>
                    </h1>
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover">
                                    ...
                                    <tbody>
                                        <?php
                                        include('../login/connect.php');
                                        $fetchdata = "SELECT * FROM  addstaff";
