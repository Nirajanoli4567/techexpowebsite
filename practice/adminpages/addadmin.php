...
<body>
    ...
    if (isset($_POST['submit'])) {
        ...
        $sqllll = "INSERT INTO addadminn(name,DOB,gender,address,number,province,village,email,image,registrationdate,username,password) VALUES ('$name','$birth','$gender','$address','$contact','$province','$village','$email','$targetFile','$date', '$username','$Password')";
    ...
    <main class="mt-5 pt-5">
        <div class="row  ms-3 me-3" style="width: auto;">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="card-body  ">
                        <span class="text-info " style=" font-weight:700; font-size:16px; "> Admin's Information:</span>
                        <div class="card-body border-1" style="border:1px solid lightgray; font-size:14px;">
                            <form class="row g-3" method="POST" enctype="multipart/form-data" action="addadmin.php">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="date" class="form-control" id="nepali-datepicker-dobb" placeholder="yyyy-mm-dd" name="DOB" required>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" class="form-control" id="city" name="village" autocomplete="off" placeholder="Enter your city/village here.." name="city" required>
                                </div>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="email" class="form-control" id="nepali-datepicker-registrationn" name="username" placeholder="Enter today's date here.." name="registrationdate" required>
                                </div>
                                <div class="col-md-4">
